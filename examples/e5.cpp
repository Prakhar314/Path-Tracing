...
int main() {
  ...
  shapes.push_back(new Plane(glm::vec3(1, 0, 0), -5, glm::vec3(0.1, 0.1, 0.8)));
  shapes.push_back(
      new Plane(glm::vec3(-1, 0, 0), -5, glm::vec3(0.8, 0.1, 0.1)));
  shapes.push_back(new Plane(glm::vec3(0, 1, 0), -5, glm::vec3(0.8, 0.8, 0.8)));
  shapes.push_back(
      new Plane(glm::vec3(0, -1, 0), -5, glm::vec3(0.8, 0.8, 0.8)));
  shapes.push_back(
      new Plane(glm::vec3(0, 0, 1), -13, glm::vec3(0.1, 0.8, 0.1)));

...
int main() {
  ...
  shapes.push_back(new Plane(glm::vec3(1, 0, 0), -5, glm::vec3(0.1, 0.4, 0.1)));
  shapes.push_back(
      new Plane(glm::vec3(-1, 0, 0), -5, glm::vec3(0.4, 0.1, 0.1)));
  shapes.push_back(new Plane(glm::vec3(0, 1, 0), -5, glm::vec3(0.2, 0.2, 0.2)));
  shapes.push_back(
      new Plane(glm::vec3(0, -1, 0), -5, glm::vec3(0.2, 0.2, 0.2)));
  shapes.push_back(
      new Plane(glm::vec3(0, 0, 1), -11, glm::vec3(0.2, 0.2, 0.2)));
  ...
  glm::mat4 model = glm::translate(glm::mat4(1.0f), glm::vec3(0, 0, -8));
  ...
  shapes.push_back(new Cuboid(glm::vec3(-2, -2, -10), glm::vec3(2, 2, -6),
                              glm::vec3(0.4, 0.4, 0.4), glm::vec3(0), model));
  shapes[shapes.size() - 1]->material = new Transparent(1.5f, true);
  shapes.push_back(new Cuboid(glm::vec3(-2, 4.9, -9.5), glm::vec3(2, 5.1, -5.0),
